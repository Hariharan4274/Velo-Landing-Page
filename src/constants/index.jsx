...
export const features = [
  {
    ...
    title: 'Deploy infrastructure in seconds',
    text: "With Velo, manual hardware configuration is history. Our automated cloud-orchestration scales your enterprise network to new heights. It's like having an elite NOC team working 24/7 without the overhead.",
    button: {
  ...
  },
  {
    ...
    title: 'Secure edge-to-edge connectivity',
    text: 'Your network integrity is our priority. With end-to-end SD-WAN encryption and robust zero-trust access controls, Velo helps keep your data packets shielded and locked tighter than a digital vault.',
    button: {
...
export const details = [
  ...
  },
  {
    ...
    title: 'Multi-Cloud Mesh Networking',
  },
  {
    id: '2',
    icon: '/images/detail-3.png',
    title: 'Low-Latency Global Backbones',
  },
  {
    id: '3',
    icon: '/images/detail-4.png',
    title: 'Instant Failover Redundancy',
  },
];
...
export const faq = [
  {
    id: '0',
    question: 'How easy is it to migrate to Velo?',
    answer:
      'Seamlessly! Our platform integrates with existing Cisco, Juniper, and AWS architectures, allowing you to transition without a single second of network downtime.',
  },
  {
    id: '1',
    question: 'Does Velo support hybrid cloud environments?',
    answer:
      'Absolutely! Velo is built for the modern enterprise, providing a unified management pane for both your on-premise servers and multi-cloud instances.',
  },
  {
    id: '2',
    question: 'How often do you release security patches?',
    answer:
      'We follow a Continuous Deployment model. Security updates are pushed to the edge in real-time as soon as new vulnerabilities are detected globally.',
  },
  {
    id: '3',
    question: 'What is your uptime Service Level Agreement (SLA)?',
    answer:
      'We guarantee 99.999% uptime. Our distributed mesh architecture ensures that even if one node fails, your traffic is rerouted instantly.',
  },
  {
    id: '4',
    question: 'Do you offer dedicated bandwidth for corporate plans?',
    answer:
      'Yes, our Enterprise and Team plans include dedicated bandwidth carving and prioritized Quality of Service (QoS) for mission-critical apps.',
  },
  {
    id: '5',
    question: 'What happens if we exceed our data cap?',
    answer:
      'Velo uses "Burst" technology. We never throttle your speed; instead, we provide temporary overage capacity to ensure your business never stops.',
  },
  {
    id: '6',
    question: 'Can I scale my nodes mid-month?',
    answer:
      'Certainly! Our elastic infrastructure allows you to add or remove virtual network nodes instantly based on your seasonal demand.',
  },
  {
    id: '7',
    question: 'How do I manage multi-site permissions?',
    answer:
      'The Velo Dashboard allows for granular Role-Based Access Control (RBAC), letting you assign specific admins to specific geographic regions.',
  },
  {
    id: '8',
    question: 'Do you provide hardware as a service (HaaS)?',
    answer:
      'Yes, we offer both software-only SD-WAN licenses and high-performance Velo-certified hardware for physical branch locations.',
  },
  {
    id: '9',
    question: 'What happens during a localized ISP outage?',
    answer:
      'Velo’s smart routing detects ISP drops in milliseconds and automatically switches your traffic to backup cellular or satellite links.',
  },
];
...
export const plans = [
  {
    ...
    priceMonthly: 59,
    priceYearly: 659,
    caption: 'Perfect for small offices',
    features: [
  ...
  },
  {
    ...
    priceMonthly: 199,
    priceYearly: 1999,
    caption: 'For scaling corporations',
    features: [
  ...
  },
  {
    ...
    priceMonthly: 99,
    priceYearly: 1199,
    caption: 'Tailored for ISP partners',
    features: [
...
export const testimonials = [
  {
    ...
    role: 'CTO at Globalnomads',
    avatarUrl: '/images/testimonials/jessica-saunders.png',
    comment:
      "Velo's networking support is elite! Our latency dropped by 40% across our European branches within the first week of deployment.",
  },
  {
    id: '1',
    name: 'Mark Erixon',
    role: 'IT Director at Vid Capital',
    avatarUrl: '/images/testimonials/mark-erixon.png',
    comment:
      "The zero-trust implementation was seamless. I can finally sleep knowing our internal network is invisible to external threats.",
  },
  {
    id: '2',
    name: 'Melanie Hurst',
    role: 'DevOps Lead at Cyberleap',
    avatarUrl: '/images/testimonials/melanie-hurst.png',
    comment:
      "Managing 50+ global sites used to be a nightmare. With Velo's dashboard, it's now a single-click operation.",
  },
  {
    id: '3',
    name: 'Alicia Barker',
    ...
    comment:
      "The real-time packet analytics are a game changer. It's like having a crystal ball for our bandwidth consumption.",
  },
  {
    id: '4',
    name: 'Becky Snider',
    role: 'Operations at Floclips',
    avatarUrl: '/images/testimonials/becky-snider.png',
    comment:
      "We switched to Velo for our remote workforce networking, and our VPN stability has never been higher. Highly recommend!",
  },
  {
    id: '5',
    name: 'Jim Bradley',
    ...
    comment:
      'The automated failover saved us during a major fiber cut. Our users didn’t even notice the switch to backup.',
  },
];
